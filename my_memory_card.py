...
questions_list.append(
        Question('Столица Германии', 'Берлин', 'Гамбург', 'Мюнхен', 'Кёльн'))
...
def ask(q: Question):
    ...
    answers[0].setStyleSheet('color: #8B2323;')
    answers[1].setStyleSheet('color: #00008B;')
    answers[2].setStyleSheet('color: #8A2BE2;')
    answers[3].setStyleSheet('color: #8B4513;')
    lb_Question.setText(q.question) # вопрос
    lb_Question.setStyleSheet('color: #DC143C;')
    lb_Correct.setText(q.right_answer) # ответ 
    lb_Question.setStyleSheet('color: #006400;')
...
btn_OK.clicked.connect(click_OK)
 # по нажатии на кнопку выбираем, что конкретно происходит
